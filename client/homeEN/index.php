    ...
    foreach ($rangeTimes as $range) {
        ...
        if ($range === $matchedRange) {
            ...
            if ($reserveCount >= $qty_reserve) {
                echo '<script>
                Swal.fire({
                    title: "Reservations are limited",
                    text: "This time slot cannot be booked. Please select a different time slot or Walk-in.",
                    icon: "error",
    ...
    try {
        ...
        if (isset($_SESSION['selectedTime'])) {
            ...
            if ($matchedRange) {
                ...
                echo '<div>ERROR: The selected time period is invalid.</div>';
            }
        } else {
        }
...
<body>
    ...
    <div class="containerMain">
        ...
        <div class="dataReserve">
            ...
            <div class="headText">
                <h2 class="textSelectTime" style="padding:8px 25px;">Select Time</h2>
